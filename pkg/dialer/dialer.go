...
// This package is meant for use with a client that consistently builds
// connections to a single host; connections to multiple hosts using this
// dialer will not see any added benefit over the default dialer.
